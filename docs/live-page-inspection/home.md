...
۴. heading نقاط که در حالت عادی «مقصدهای محبوب» و پس از جست‌وجو «نتایج مرتبط» است.
۵. grid نقاط؛ در حالت عادی شش tile: توچال، دماوند، دشت دریاسر، جنگل ابر، کویر مرنجاب، دریاچه گهر.

[LIVE] بعد از hero، فوتر مشترک با لینک‌های آیکونی شبکه‌های اجتماعی قرار دارد.
...
| theme dark | `☼ روشن` |
| theme light | `◐ تیره` |
| hero heading | `هوای مسیرت را ببین` |
