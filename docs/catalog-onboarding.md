...
انتشار تا زمانی که حداقل یک Route پیادهٔ کامل و مستند از مبدأ واقعی تا همان مقصد
نداشته باشیم مجاز نیست. این Route باید ترک پیوسته، حداقل یک عارضهٔ میانی واقعی و
تطبیق مستقل برای فاصله/ارتفاع/زمان داشته باشد؛ در غیر این صورت مقصد در وضعیت
pending می‌ماند و صفحهٔ عمومی آن ساخته نمی‌شود. استثنای `point-only` فقط برای
عارضه‌هایی است که واقعاً مسیر پیادهٔ عمومی ندارند (مثل نقطهٔ آبی یا دسترسی صرفاً
خودرویی) و نباید برای دورزدن این gate استفاده شود.
