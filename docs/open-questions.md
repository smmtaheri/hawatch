...
| OQ-009 | PASS | مدل forecast روزها، period و unitها چیست؟ | پنجرهٔ ۷روزه، timezone رسمی `Asia/Tehran` و چهار پنجرهٔ ثابت با سه برش دوساعته در API/UI محلی پیاده شده است. | بامداد ۰۰–۰۶، صبح ۰۶–۱۲، ظهر ۱۲–۱۸ و شب ۱۸–۲۴؛ انتخاب پیش‌فرض بر اساس ساعت تهران است. |
