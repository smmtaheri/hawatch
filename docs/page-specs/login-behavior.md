...
- برای تست موقت، فقط شمارهٔ مجاز پیکربندی‌شده پذیرفته می‌شود و کد ثابت داخلی استفاده می‌شود؛ هیچ مقدار محرمانه‌ای در رابط یا placeholder نمایش داده نمی‌شود و درخواست OTP خارجی ارسال نمی‌شود.
