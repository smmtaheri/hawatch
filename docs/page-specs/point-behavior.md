...
پنجره‌ها ثابت و غیرهم‌پوشان‌اند: نیمه‌شب ۰۰–۰۶، صبح ۰۶–۱۲، ظهر ۱۲–۱۸ و شب ۱۸–۲۴؛ هر پنجره سه برش دوساعته دارد. بازهٔ کاملاً گذشته نسبت به `meta.current_local_time` در `Asia/Tehran` کم‌رنگ است، اما بازهٔ انتخاب‌شده همچنان خوانا می‌ماند. بدون query صریح، API بر اساس ساعت تهران `date` و `period` پیش‌فرض برمی‌گرداند.
