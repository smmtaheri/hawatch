...
هر مقصد جدید URL یا لیست دستی در frontend نسازید. مقصدی که برای هدف پیمایش یا
صعود اضافه می‌شود باید پیش از انتشار حداقل یک Route پیادهٔ کامل، پیوسته و
مستند از مبدأ واقعی تا همان مقصد داشته باشد؛ در غیر این صورت در وضعیت pending
می‌ماند. waypointهای فنی و نقاط صرفاً
