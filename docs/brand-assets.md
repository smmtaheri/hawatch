...
- `hawatch-logo-mark-dark.svg`: نشان رسمی کوه، پیچ مسیر و ابر برای سطح‌های تیره؛ پس‌زمینهٔ آن شفاف است و ابر سفید دارد. نام مستقل آن باعث می‌شود cache نسخهٔ مربعی قدیمی به Header، ورود یا SSR برنگردد.
- `hawatch-logo-mark-light.svg`: همان نشان و همان هندسهٔ کوه و پیچ مسیر برای سطح‌های روشن؛ فقط رنگ ابر تیره است تا روی سفید خوانا بماند.
- Header، ورود و HTML اولیهٔ SSR با `html[data-theme]` بین این دو asset جابه‌جا می‌شوند؛ نشان هیچ کادر یا پس‌زمینهٔ مشکی ندارد.
...
favicon و آیکون‌های PWA از نشان رسمی با پس‌زمینهٔ شفاف ساخته شده‌اند و مسیرهای عمومی آن‌ها ثابت مانده است:
