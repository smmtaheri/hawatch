...
- mobile: hero مسیر کوتاه و بدون breadcrumb تکراری است؛ عنوان و status در دو سوی hero و در مرکز ارتفاع آن می‌مانند. کنترل‌ها کوچک و هم‌ارتفاع؛ ساعت و سرعت در یک ردیف؛ خط جداکنندهٔ عمودی حذف؛ فقط یک کنترل مشترک سه‌گزینه‌ای صبح/بعدازظهر/شب.
