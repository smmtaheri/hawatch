...
۷. بخش مسیرها.
۸. انتخاب نیمه‌شب/صبح/ظهر/شب؛ بازهٔ جاری پررنگ و بازه‌های کاملاً گذشته کم‌رنگ.
۹. پیش‌بینی ساعتی با سه کارت دوساعته در هر بازه (نیمه‌شب ۰۰، ۰۲، ۰۴؛ صبح ۰۶، ۰۸، ۱۰؛ ظهر ۱۲، ۱۴، ۱۶؛ شب ۱۸، ۲۰، ۲۲).
۱۰. جزئیات تخصصی.
