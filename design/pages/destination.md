...
- mobile: روزها با label «انتخاب روز» قبل از کنترل هوا باشند؛ مسیرهای مرتبط/مقصد در کارت‌های فشرده و بدون کشیدگی باشند؛ کنترل سه‌گزینه‌ای صبح/بعدازظهر/شب در یک ردیف مستقل و خوانا باشد؛ cardها فقط در container خودشان scroll شوند.
