...
۷. بخش مسیرها.
۸. انتخاب بامداد/صبح/ظهر/شب؛ بازهٔ جاری پررنگ و بازه‌های کاملاً گذشته کم‌رنگ.
۹. پیش‌بینی ساعتی با سه کارت دوساعته در هر بازه (بامداد ۰۰، ۰۲، ۰۴؛ صبح ۰۶، ۰۸، ۱۰؛ ظهر ۱۲، ۱۴، ۱۶؛ شب ۱۸، ۲۰، ۲۲).
۱۰. جزئیات تخصصی.
...
- بامداد/صبح/ظهر/شب: hourly forecast و وضعیت نقاط مرتبط را عوض می‌کند.
...
- forecast روزانه و hourly با بازه‌های بامداد ۰۰–۰۶، صبح ۰۶–۱۲، ظهر ۱۲–۱۸ و شب ۱۸–۲۴.
