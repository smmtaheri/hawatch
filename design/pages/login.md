...
Login در درخواست جاری جزو سه صفحهٔ بررسی زنده نیست؛ سند آن همچنان فقط reference تصویری milestone قبلی است.

## ۱. هدف صفحه و تصمیم کاربر

Login برای ورود با شمارهٔ موبایل و دریافت کد ورود طراحی شده است. در این مرحله هدف فقط ثبت reference بصری و رفتار مورد انتظار است؛ Login در milestone اول implementation نمی‌شود.
...
- Login در milestone اول هیچ کد اجرایی یا API واقعی نداشته باشد.
