...
- `stale`: دادهٔ قدیمی با هشدار human-readable ملایم («دادهٔ نمایش‌داده‌شده ممکن است قدیمی باشد…»)؛ timestamp خام ISO یا برچسب «آخرین به‌روزرسانی» در UI عمومی رندر نمی‌شود.
