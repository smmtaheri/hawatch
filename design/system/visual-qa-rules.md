...
- Destination: روزها قبل از weather controls، مسیرها دو ستونه و عنوان فقط «مسیرها» باشد.
- Route: کنترل‌ها کوچک و هم‌ارتفاع، ساعت و سرعت هم‌ردیف، خط جداکنندهٔ عمودی حذف‌شده و یک toggle چهارگزینه‌ای نیمه‌شب/صبح/ظهر/شب وجود داشته باشد.
...
- layout چندستونه در Destination و Route با تبدیل ناگهانی به overflow جایگزین نشود.
