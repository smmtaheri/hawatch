...
const destinationForecast = {
  ...
  period: { id: "morning", label: "صبح", range_label: "۰۰ تا ۱۲", headline: "تغییرات نیمهٔ اول روز · هر دو ساعت", hours: [0, 2, 4, 6, 8, 10] },
  current: null,
  hourly: [
    { time: "۰۰:۰۰", hour: 0, temperature_c: 7, temperature_label: "۷°", condition: "صاف", icon: "☼", wind_speed_kmh: 7, wind_label: "باد ۷ km/h", severity: "normal", state: "normal", is_yesterday: false, is_today: true, is_past: true, is_current: false, is_future: false },
  ],
...
const routeForecast = {
  ...
  period: { id: "morning", label: "صبح", range_label: "۰۰ تا ۱۲", hours: [0, 2, 4, 6, 8, 10] },
  start_minutes: 360,
  start_time: "۰۶:۰۰",
  speed: "متوسط",
  speed_options: ["آرام", "متوسط", "سریع"],
  points: [
    { slug: "darband", name: "دربند", elevation_label: "۱۸۰۰ m", href: "/destination-point/darband", axis_x: 10, axis_y: 83, time: "۰۶:۰۰", temp: 8, wind: 6, icon: "☼", condition: "شروع آرام", state: "normal", note: "شروع آرام", arrival_minutes: 360 },
  ],
