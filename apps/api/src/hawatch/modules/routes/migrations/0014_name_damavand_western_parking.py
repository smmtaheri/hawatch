...
POINT_SLUG = "damavand_western_parking"
POINT_NAME = "پارکینگ غربی دماوند"
POINT_ALIASES = ("پارکینگ غربی",)
...
def name_damavand_western_parking(apps, schema_editor):
    ...
    # Keep the denormalized search index consistent with the canonical point
    # name while retaining the old short phrase as a searchable alias.
    existing_rows = list(
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("routes", "0013_remove_damavand_western_points"),
    ]

    operations = [
        migrations.RunPython(name_damavand_western_parking, migrations.RunPython.noop),
    ]
