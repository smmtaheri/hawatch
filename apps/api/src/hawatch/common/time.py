...
HOURLY_STEP = 2
MORNING_HOURS = (0, 2, 4, 6, 8, 10)
AFTERNOON_HOURS = (12, 14, 16, 18, 20, 22)
...
PERIODS = {
    "morning": {
        "id": "morning",
        "label": "صبح",
        "range_label": "۰۰ تا ۱۲",
        "start_minutes": 0,
        "end_minutes": 720,
        "default_start": 360,
        "hours": MORNING_HOURS,
        "headline": "تغییرات نیمهٔ اول روز · هر دو ساعت",
    },
    "afternoon": {
        "id": "afternoon",
        "label": "بعدازظهر",
        "range_label": "۱۲ تا ۲۴",
        "start_minutes": 720,
        "end_minutes": 1440,
        "default_start": 720,
        "hours": AFTERNOON_HOURS,
        "headline": "تغییرات نیمهٔ دوم روز · هر دو ساعت",
    },
}
...
def parse_start_minutes(raw: str | None, period: str, default: int) -> int:
    spec = PERIODS[period]
